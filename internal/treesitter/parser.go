...
func languageForQueryKey(queryKey string) *tree_sitter.Language {
	...
	case "gleam":
		return tree_sitter.NewLanguage(tree_sitter_gleam.Language())
	case "haskell":
	...
	case "matlab":
		return tree_sitter.NewLanguage(tree_sitter_matlab.Language())
	case "ocaml":
	...
	case "ql":
		return tree_sitter.NewLanguage(tree_sitter_ql.Language())
	case "python":
	...
	case "udev":
		return tree_sitter.NewLanguage(tree_sitter_udev.Language())
	default:
		return nil
	}
}
