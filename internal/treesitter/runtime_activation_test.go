...
func TestParserRuntimeActivation_Gate(t *testing.T) {
	...
	testCases := []struct {
		...
		// Gleam (runtime-registered + query-backed)
		{name: "gleam", lang: "gleam", queryKey: "gleam", extension: "gleam", activationType: "ok"},
		// QL (runtime-registered + query-backed)
		{name: "ql", lang: "ql", queryKey: "ql", extension: "ql", activationType: "ok"},
		// Udev (runtime-registered + query-backed)
		{name: "udev", lang: "udev", queryKey: "udev", extension: "rules", activationType: "ok"},
		// Elixir (runtime-registered + query-backed, added by T11)
		{name: "elixir", lang: "elixir", queryKey: "elixir", extension: "ex", activationType: "ok"},
		// Kotlin (runtime-registered + query-backed, added by T11)
		{name: "kotlin", lang: "kotlin", queryKey: "kotlin", extension: "kt", activationType: "ok"},
		// Matlab (runtime-registered + query-backed, added by T11)
		{name: "matlab", lang: "matlab", queryKey: "matlab", extension: "m", activationType: "ok"},
