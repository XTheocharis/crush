...
func verifyMatrixEnforcement(inv *RuntimeInventory, evidence *phase0CGateEvidence) error {
	...
	testCases := []struct {
		...
		{"text", true, "text_format_generic"},
		{"go", true, "code_format_native"},
		{"python", true, "code_format_native"},
		{"javascript", true, "code_format_native"},
		{"typescript", true, "code_format_native"},
		{"rust", true, "code_format_native"},
		{"java", true, "code_format_native"},
		{"cpp", true, "code_format_native"},
		{"c", true, "code_format_native"},
		{"ruby", true, "code_format_native"},
		{"shell", true, "shell_format_native"},
		{"json", true, "data_format_native"},
		{"yaml", true, "data_format_native"},
		{"csv", true, "data_format_native"},
		{"toml", true, "data_format_native"},
		{"ini", true, "data_format_native"},
		{"xml", true, "data_format_native"},
		{"html", true, "data_format_native"},
		{"binary", false, "native_binary"},
		{"fallback", false, "fallback_final"},
	}
