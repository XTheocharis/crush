...
func coderAgent(r *vcr.Recorder, env fakeEnv, large, small fantasy.LanguageModel) (SessionAgent, error) {
	...
	cfg.Config().Options.DisabledSkills = []string{"crush-config", "crush-hooks", "crush-logs", "jq"}
	...
	allTools := []fantasy.AgentTool{
		...
		tools.NewViewTool(nil, env.permissions, *env.filetracker, nil, env.workingDir, nil),
