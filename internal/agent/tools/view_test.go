...
func (m mockFileTracker) RecordWrite(ctx context.Context, sessionID, path string) error {
	return nil
}
...
func (m mockFileTracker) ListRecentReadFiles(ctx context.Context, since time.Duration) ([]string, error) {
	return nil, nil
}
